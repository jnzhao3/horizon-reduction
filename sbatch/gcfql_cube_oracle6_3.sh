...
declare -a commands=(
 [1]='python3 main.py --run_group gcfql_cube_oracle6_3 --env_name cube-triple-play-oraclerep-v0 --agent ../agents/gcfql.py --dataset_dir ../../scratch/data/cube-triple-play-v0 --train_data_size 100000 --offline_steps 2000000 --save_interval 200000 --save_dir ../../scratch/gcfql/ --agent.alpha 300 --agent.actor_type best-of-n --agent.train_goal_proposer=True --agent.actor_hidden_dims 512,512,512,512 --agent.value_hidden_dims 512,512,512,512 --agent.batch_size 256 --agent.num_actions 4 --agent.num_qs 4 --agent.subgoal_steps 10 --agent.value_loss_type squared --json_path ../jsons/data.json --agent.awr_invtemp 0.0'
 [2]='python3 main.py --run_group gcfql_cube_oracle6_3 --env_name cube-triple-play-oraclerep-v0 --agent ../agents/gcfql.py --dataset_dir ../../scratch/data/cube-triple-play-v0 --train_data_size 100000 --offline_steps 2000000 --save_interval 200000 --save_dir ../../scratch/gcfql/ --agent.alpha 300 --agent.actor_type best-of-n --agent.train_goal_proposer=True --agent.actor_hidden_dims 512,512,512,512 --agent.value_hidden_dims 512,512,512,512 --agent.batch_size 256 --agent.num_actions 4 --agent.num_qs 4 --agent.subgoal_steps 10 --agent.value_loss_type squared --json_path ../jsons/data.json --agent.awr_invtemp 1.0'
)
