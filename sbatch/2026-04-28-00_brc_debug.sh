...
declare -a commands=(
  [1]='MUJOCO_GL=egl python 10_data_collection_experiment.py --restore_path=../../scratch/dqc-reproduce/sd100001s_33415523.0.33415522.1.20260415_020458/ --dataset_path=../../scratch/data/humanoidmaze-giant-navigate-v0/humanoidmaze-giant-navigate-100m-v0/humanoidmaze-giant-navigate-v0-003.npz --env_name=humanoidmaze-giant-navigate-v0 --ckpt_num=1000000 --task_id=1 --subgoal_steps=100 --steps_to_subgoal=25 --num_train_steps=50 --num_additional_steps=50 --fql_train_steps=50 --num_subgoals=16 --mult_factor=0.9 --additive_factor=0.0 --A_B_factor=1.0 --B_C_factor=0.0 --seed=1000 --wandb_group=2026-04-28-00_debug'
)
