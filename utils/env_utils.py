...
def make_env_and_datasets(dataset_name, frame_stack=None, add_info=False):
    ...
    env, train_dataset, val_dataset = ogbench.make_env_and_datasets(dataset_name, compact_dataset=True, add_info=add_info)
