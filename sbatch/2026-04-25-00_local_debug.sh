...
scripts=(
  "MUJOCO_GL=egl python 10_data_collection_experiment.py --task_id=1 --subgoal_steps=100 --steps_to_subgoal=25 --num_train_steps=50 --num_additional_steps=50 --fql_train_steps=50 --num_subgoals=16 --mult_factor=0.9 --additive_factor=0.0 --A_B_factor=1.0 --B_C_factor=0.0 --seed=1000 --wandb_group=2026-04-25-00_debug"
)
