...
declare -a commands=(
 [1]='python3 main.py --run_group debugging --env_name cube-triple-play-oraclerep-v0 --agent ../agents/gcfql.py --dataset_dir ../../scratch/data/cube-triple-play-v0 --train_data_size 100 --offline_steps 100 --log_interval 50 --save_interval 50 --save_dir ../../scratch/gcfql/ --agent.alpha 300 --agent.actor_type best-of-n --json_path ../jsons/data.json'
)
