...
parser.add_argument('--save_dir', type=str, default='checkpoints/data_collection_giant')
...
parser.add_argument('--flow_restore_path', type=str, default='checkpoints/gc_flow_goal_proposer/observation_horizon_h1_100')
