...
env_suffix = [f'-singletask-task{i}-v0' for i in range(3, 5)] # modified because I already ran 1
data_suffix = "-v0"
            ...
            for seed in [1001, 2002, 3003]:
                ...
                for env_name, data_dir in zip(env_names, data_dirs):
                    ...
                    base_kwargs = {
                        ...
                        "agent.alpha": alpha # agent_params["FQL"][domain]["alpha"],
                    }
