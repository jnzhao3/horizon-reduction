...
declare -a commands=(
 [1]='python3 main.py --run_group gcfql_maze_oracle3_1 --env_name humanoidmaze-large-navigate-oraclerep-v0 --agent ../agents/gcfql.py --dataset_dir ../../scratch/data/humanoidmaze-large-navigate-v0 --train_data_size 100000 --save_dir ../../scratch/gcfql/ --agent.alpha 300 --agent.actor_type best-of-n --agent.train_goal_proposer True --json_path ../jsons/data.json'
)
