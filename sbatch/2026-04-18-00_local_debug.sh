...
scripts=(
  "MUJOCO_GL=egl python 07_tuning_goal_proposer.py --subgoal_steps=25 --steps_to_subgoal=25 --num_train_steps=50 --num_trials=1 --num_trial_steps=50 --num_subgoals=16 --mult_factor=0.9 --additive_factor=0.0 --A_B_factor=1.0 --B_C_factor=0.0 --seed=1001 --wandb_group=2026-04-18-00_debug"
)
