...
declare -a commands=(
 [1]='python3 main.py --run_group gcfql_cube_oracle5 --env_name cube-quadruple-play-oraclerep-v0 --agent ../agents/gcfql.py --dataset_dir ../../scratch/data/cube-quadruple-play-v0 --train_data_size 100000 --save_dir ../../scratch/gcfql/ --agent.alpha 300 --agent.actor_type best-of-n --json_path ../jsons/data.json'
)
